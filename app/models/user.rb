class User < ApplicationRecord
  ...
  # AI-powered finance coaching associations
  has_one :financial_personality, dependent: :destroy
  has_many :budget_recommendations, dependent: :destroy
  has_many :spending_insights, dependent: :destroy
  has_many :spending_habits, dependent: :destroy
  has_many :ai_coaching_sessions, dependent: :destroy
  has_many :ai_notifications, dependent: :destroy
