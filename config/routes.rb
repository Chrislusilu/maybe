...
Rails.application.routes.draw do
  ...
  # AI Financial Coaching routes
  get 'ai_coaching', to: 'ai_coaching#dashboard'
  get 'ai_coaching/dashboard', to: 'ai_coaching#dashboard'
  get 'ai_coaching/personality_analysis', to: 'ai_coaching#personality_analysis'
  get 'ai_coaching/budget_recommendations', to: 'ai_coaching#budget_recommendations'
  post 'ai_coaching/adopt_budget/:id', to: 'ai_coaching#adopt_budget', as: :adopt_budget
  post 'ai_coaching/purchase_guidance', to: 'ai_coaching#purchase_guidance'
  post 'ai_coaching/crisis_intervention', to: 'ai_coaching#crisis_intervention'
  patch 'ai_coaching/acknowledge_insight/:id', to: 'ai_coaching#acknowledge_insight', as: :acknowledge_insight
  post 'ai_coaching/session_feedback/:id', to: 'ai_coaching#session_feedback', as: :ai_coaching_session_feedback
  post 'ai_coaching/regenerate_personality', to: 'ai_coaching#regenerate_personality'
  post 'ai_coaching/regenerate_budget_recommendations', to: 'ai_coaching#regenerate_budget_recommendations'
